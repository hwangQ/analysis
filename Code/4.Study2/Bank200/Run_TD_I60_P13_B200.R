...
content_df <- content_table(x=mstTD, which.mst=obj_df$loc.mre[c(1:4)], mod.name=c("1M", "2E", "2M", "2H")) 
...
plot(x = mstTD[[1222]], ylab.text = "Information", range.theta, D=D, 
     legend.text=c("1M-2E", "1M-2M", "1M-2H"))
